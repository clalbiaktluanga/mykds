  ...
  return (
    <div style={{ padding: '1rem', maxWidth: 1100, margin: '0 auto' }}>
      ...
      <div style={{ marginBottom: '0.5rem' }}>
        <div style={{ fontSize: '0.72rem', fontWeight: 600, color: 'var(--charcoal-light)',
      ...
      {/* Marks table — admin overview (all subjects) */}
      {loading ? (
        ...
        <>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse',
              ...
              <thead>
                <tr>
                  ...
                  <th style={{ ...thStyle, textAlign: 'center', minWidth: 90, background: '#d0ecfd' }}>
                    Total
                  </th>
                </tr>
              </thead>
                          ...
                          <td key={subject} style={{ ...tdStyle, textAlign: 'center' }}>
                            {score !== null && score !== undefined ? (
                              <span style={{
                                ...
                                fontWeight: 600, fontSize: '0.82rem', minWidth: 42,
                              }}>{score}</span>
                            ) : (
          ...
          {/* Per-subject edit history using MarksViewer */}
            ...
            {data.classes.map(cls => (
              <div key={cls._id} style={{ marginBottom: '1.5rem' }}>
                <div style={{ fontSize: '0.85rem', fontWeight: 600,
                  ...
                  <span style={{ background: 'var(--sky-light)',
